...
import "./Login.css";
import logo from "./Arizona_State_University_seal.svg";

// import social from "./Arizona_State_University_seal.svg";
import social from "./ASU_Devil.png";
  ...
  return (
    <div className="login">
      ...
      <a href="https://devils-den-1.vercel.app/" target="_blank">
        <img className="login__myASUImage" src={social} alt="ASU_logo" />
